...
data {
  ...
  vector[8] beta_report_lower_bounds;
}
transformed data {
  ...
  matrix[N_train, 8] X_report_train_std;
  matrix[N_test, 2] X_mesh_test_std;
  matrix[N_test, 8] X_report_test_std;
...
transformed parameters {
  ...
  beta_report[3:8] = beta_report_raw[3:8];
...
model {
  ...
  target += normal_lpdf(beta_report_raw[3:8] | 0.0, 1.0 / 3.0);
