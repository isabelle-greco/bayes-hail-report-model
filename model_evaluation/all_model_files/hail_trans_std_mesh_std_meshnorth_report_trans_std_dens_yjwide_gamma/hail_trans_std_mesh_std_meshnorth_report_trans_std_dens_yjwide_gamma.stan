...
transformed parameters {
  ...
  real mesh_train_untrans_mean = mean(X_mesh_train[, 3]);
  real mesh_train_untrans_sd = sd(X_mesh_train[, 3]);
  ...
  X_mesh_train_std_trans[, 3] = (X_mesh_train[, 3] - mesh_train_untrans_mean) / mesh_train_untrans_sd;

  X_mesh_test_std_trans[, 1] = X_mesh_test[, 1];
  X_mesh_test_std_trans[, 2] = (mesh_test_yj - mesh_train_yj_mean) / mesh_train_yj_sd;
  X_mesh_test_std_trans[, 3] = (X_mesh_test[, 3] - mesh_train_untrans_mean) / mesh_train_untrans_sd;
  ...
  beta_hail[1] = beta_hail_raw[1] - (beta_hail_raw[2] * (mesh_train_yj_mean / mesh_train_yj_sd)) - (beta_hail_raw[4] * (mesh_train_untrans_mean / mesh_train_untrans_sd));
  beta_hail[2] = beta_hail_raw[2] / mesh_train_yj_sd;
  beta_hail[3] = beta_hail_raw[3];
  beta_hail[4] = beta_hail_raw[4] / mesh_train_untrans_sd;
}
