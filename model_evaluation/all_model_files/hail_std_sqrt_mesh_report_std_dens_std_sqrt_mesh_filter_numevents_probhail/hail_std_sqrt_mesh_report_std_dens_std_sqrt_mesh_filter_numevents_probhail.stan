...
transformed data {
  ...
  matrix[N_train, 3] X_report_train_std;
  matrix[N_test, 2] X_mesh_test_std;
  matrix[N_test, 3] X_report_test_std;
  ...
  X_report_train_std[, 3] = (X_report_train[, 3] - mesh_train_untrans_mean) / mesh_train_untrans_sd;
  X_report_test_std[, 1] = X_report_test[, 1];
  X_report_test_std[, 2] = (X_report_test[, 2] - dens_train_mean) / dens_train_sd;
  X_report_test_std[, 3] = (X_report_test[, 3] - mesh_train_untrans_mean) / mesh_train_untrans_sd;
}
// parameters
parameters {
...
transformed parameters {
  ...
  beta_report[1] = beta_report_raw[1] - (beta_report_raw[2] * (dens_train_mean / dens_train_sd)) - (beta_report_raw[3] * (mesh_train_untrans_mean / mesh_train_untrans_sd));
  beta_report[2] = beta_report_raw[2] / dens_train_sd;
  beta_report[3] = beta_report_raw[3] / mesh_train_untrans_sd;
