...
transformed data {
  ...
  matrix[N_train, 9] X_report_train_std;
  matrix[N_test, 2] X_mesh_test_std;
  matrix[N_test, 9] X_report_test_std;
...
model {
  ...
  target += normal_lpdf(beta_report_raw[3:9] | 0.0, 1.0 / 3.0);
