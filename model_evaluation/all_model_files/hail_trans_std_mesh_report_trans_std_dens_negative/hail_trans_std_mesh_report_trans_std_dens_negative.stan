...
model {
  ...
  // priors
  target += normal_lpdf(beta_hail_raw[1] | -6.0, 4.0);
  target += normal_lpdf(beta_hail_raw[2] | 0.0, 0.5);
  target += normal_lpdf(beta_hail_raw[3] | 1.0, 1.0 / 3.0);
  target += normal_lpdf(beta_report_raw[1] | -6.0, 4.0);
  target += normal_lpdf(beta_report_raw[2] | 0.0, 0.5);
