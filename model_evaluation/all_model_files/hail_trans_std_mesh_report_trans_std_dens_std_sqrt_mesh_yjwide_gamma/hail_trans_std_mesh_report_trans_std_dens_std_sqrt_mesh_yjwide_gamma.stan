...
transformed parameters {
  ...
  real mesh_train_untrans_mean = mean(X_report_train[, 3]);
  real mesh_train_untrans_sd = sd(X_report_train[, 3]);
  ...
  X_report_train_std_trans[, 3] = (X_report_train[, 3] - mesh_train_untrans_mean) / mesh_train_untrans_sd;

  X_report_test_std_trans[, 1] = X_report_test[, 1];
  X_report_test_std_trans[, 2] = (dens_test_yj - dens_train_yj_mean) / dens_train_yj_sd;
  X_report_test_std_trans[, 3] = (X_report_test[, 3] - mesh_train_untrans_mean) / mesh_train_untrans_sd;
  {
  ...
  // unstandardised parameters  
  beta_report[1] = beta_report_raw[1] - (beta_report_raw[2] * (dens_train_yj_mean / dens_train_yj_sd)) - (beta_report_raw[4] * (mesh_train_untrans_mean / mesh_train_untrans_sd));
  beta_report[2] = beta_report_raw[2] / dens_train_yj_sd;
  beta_report[3] = beta_report_raw[3];
  beta_report[4] = beta_report_raw[4] / mesh_train_untrans_sd;
