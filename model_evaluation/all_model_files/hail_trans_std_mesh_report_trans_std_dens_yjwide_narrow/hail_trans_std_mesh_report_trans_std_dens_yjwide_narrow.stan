...
model {
  ...
  // priors
  target += normal_lpdf(beta_hail_raw[1] | -2.0, 2.0);
  target += normal_lpdf(beta_hail_raw[2] | 0.5, 0.25);
  target += normal_lpdf(beta_hail_raw[3] | 1.0, 2.0 / 3.0);
  target += normal_lpdf(beta_report_raw[1] | -2.0, 2.0);
  target += normal_lpdf(beta_report_raw[2] | 0.5, 0.25);
