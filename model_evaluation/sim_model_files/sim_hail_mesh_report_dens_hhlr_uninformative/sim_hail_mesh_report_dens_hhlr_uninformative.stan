...
model {
  ...
  // priors
  target += normal_lpdf(beta_hail[1] | -8.0, 3.0 / 6.0);
  target += normal_lpdf(beta_hail[2] | 0.3, 3.0 / 30.0);
  target += normal_lpdf(beta_report[1] | -4.258, 55.0 / 30.0);
  target += normal_lpdf(beta_report[2] | 0.5, 5.0 / 12.0);
}
