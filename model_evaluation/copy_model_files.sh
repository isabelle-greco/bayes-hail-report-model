...
### Script to copy model files (.stan, .R, and .txt) to Gadi where they can 
### be run using run_and_evaluate_model_parallel.sh
### 
...
MODEL_CURRENT_DIRECTORY="all_model_files"
